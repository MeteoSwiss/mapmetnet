...
class GBONMapper(CountryMapper):
    ...
    def generate_map(self, figid: int = 1, pad_frac: float = 0.2,
        ...
        Note:
            ...
            Appendix A, and also the documentation of the associated `Python implementation`_.
            In short, it corresponds to the area in the immediate vicinty of a station for which
            the GBON requirements (in terms station proximity) are met.
            ...
            .. _Python implementation: https://meteoswiss.github.io/wmoutils/gbon.html#gbon-radius-of-influence
